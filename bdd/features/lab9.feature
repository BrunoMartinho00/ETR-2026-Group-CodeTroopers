Feature: Gatekeeper de Qualidade e Consistência de Dados (Variante 4)
  ...
  Scenario: Prevenir informações contraditórias de Disaster Recovery
  ...
  Scenario: Permitir progresso parcial através do modo Rascunho (Draft)
  ...
  Scenario: Detetar nome de ativo duplicado através da Base de Dados de Ativos
  ...
  Scenario: Happy path — Submissão de inventário com dados consistentes e completos
