...
| REQ-004 | AC-1, AC-2 | T-01, T-02, T-03 (`tests/unit/test_lab11_validations.py`) | None | `docs/test_first_log.md`, `tests/unit/test_lab11_validations.py` | Dashboard URL validation automated in Lab 11 |
